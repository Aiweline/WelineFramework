...
4. `dev/ai/diagrams/08-module-docs-index.txt`, then each owning module's `doc/AI-INDEX.md`
...
- Module docs protocol: `dev/ai/diagrams/08-module-docs-index.txt` → `app/code/{Vendor}/{Module}/doc/AI-INDEX.md`
