...
3. In second-level acceptance mode:
   - Read the Technical Lead first-level acceptance, QA verdict, specialist reports, changed files, commands, validation evidence, runtime cleanup or manual-acceptance handoff proof, documentation status, and release risk.
