...
4. 如果目标技能正文再引用其它技能或 reference，再继续按需读取。

## 常驻

| 场景/关键词 | 技能 | 读取目标 |
|---|---|---|
| 上下文过长、切任务、需要压缩 Token、交接摘要 | context-compression | `dev/ai/skills/context-compression/SKILL.md` |
...
| Cursor CLI、cursor 命令、agent 命令、脚本集成 | cursor-cli | `dev/ai/skills/cursor-cli/SKILL.md` |
...
| 规则、技能、计划、`dev/ai`、`.cursor` 引用关系 | cursor-as-reference | `dev/ai/skills/cursor-as-reference/SKILL.md` |
