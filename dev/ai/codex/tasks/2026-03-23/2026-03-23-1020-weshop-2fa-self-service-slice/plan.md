...
- [x] Inspect `Weline_TwoFactorAuth` services, models, controllers, and existing user-facing entry points.
- [x] Map the current WeShop auth orchestration to the framework 2FA data model for storefront and backend actors.
