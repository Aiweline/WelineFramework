...
class TradeActorRuntimeProofService
{
    ...
    private const ACL_SOURCES = [
        self::ROLE_PROVIDER => 'GuoLaiRen_A2A::agent_operator',
        self::ROLE_PLATFORM => 'GuoLaiRen_A2A::platform_risk',
        self::ROLE_ARBITRATOR => 'GuoLaiRen_A2A::arbitration_panel',
    ];

    private const ACL_PROOF_ROUTES = [
        'GuoLaiRen_A2A::agent_operator' => 'a2a/backend/acl-proof/agent-operator',
        'GuoLaiRen_A2A::platform_risk' => 'a2a/backend/acl-proof/platform-risk',
        'GuoLaiRen_A2A::arbitration_panel' => 'a2a/backend/acl-proof/arbitration-panel',
    ];
