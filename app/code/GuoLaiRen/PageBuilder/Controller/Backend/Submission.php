...
#[\Weline\Framework\Acl\Acl('GuoLaiRen_PageBuilder::form_submissions', '表单提交管理', 'mdi mdi-email-open', '管理表单提交记录')]
class Submission extends BackendController
{
    ...
    #[\Weline\Framework\Acl\Acl('GuoLaiRen_PageBuilder::form_submissions_index', '查看提交列表', 'mdi mdi-view-list', '查看表单提交列表')]
    ...
    #[\Weline\Framework\Acl\Acl('GuoLaiRen_PageBuilder::form_submissions_view', '查看提交详情', 'mdi mdi-eye', '查看提交详情')]
    ...
    #[\Weline\Framework\Acl\Acl('GuoLaiRen_PageBuilder::form_submissions_delete', '删除提交记录', 'mdi mdi-delete', '删除提交记录')]
    ...
    #[\Weline\Framework\Acl\Acl('GuoLaiRen_PageBuilder::form_submissions_export', '导出提交记录', 'mdi mdi-download', '导出提交记录为CSV')]
