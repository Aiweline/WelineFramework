# Indian Rummy Voltage (Indian Rummy Voltage) 模板

## 📋 模板概述

这是一个专为 Indian Rummy Voltage 游戏网站设计的完整落地页模板，基于 https://www.indian-rummy-voltage.example/ 网站内容创建。模板包含所有必要的元素，并且每个元素都可以通过可视化配置进行自定义。
...
indian-rummy-voltage 模板已支持可视化组件系统，可以：
...
**模板路径**: `GuoLaiRen_PageBuilder::style/indian-rummy-voltage`
