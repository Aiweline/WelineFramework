# Court Piece Electric Mahal (TPMST) 模板

## 📋 模板概述

这是一个专为 Court Piece Electric Mahal 游戏网站设计的完整落地页模板，基于 https://www.court-piece-electric-mahal.com/ 网站内容创建。模板包含所有必要的元素，并且每个元素都可以通过可视化配置进行自定义。
...
court-piece-electric-mahal 模板已支持可视化组件系统，可以：
...
1. 进入后台：**内容管理 > 页面构建器**
2. 点击"新建页面"
3. 选择样式模板：**court-piece-electric-mahal**
...
**模板路径**: `GuoLaiRen_PageBuilder::style/court-piece-electric-mahal`
