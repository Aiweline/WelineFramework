# Call Break Legend Theme

## 🎴 主题概述

**Call Break Legend** 是一个专为印度流行纸牌游戏设计的现代化、响应式主题模板。采用深海蓝+翠绿+琥珀金配色方案，集成 Tailwind CSS 框架，提供完美的移动端体验。

### 🎯 核心特点

- ✅ **全新视觉风格** - 深海翠金主题，区别于其他主题
...
- **主色调**: 深海蓝 (#0b1525) → 深海蓝 (#0f2538)
- **强调色**: 翠绿 (#1eb980) + 琥珀金 (#f2a93b)
- **背景**: 多层渐变 + 径向光晕效果
- **文字**: 白色/浅灰色系
...
- 印度纸牌游戏推广（Call Break、Rummy、Teen Patti）
- 在线赌场游戏平台
- 移动游戏应用下载页
- 游戏社区网站
- 竞技游戏平台
...
tailwind.config = {
  theme: {
    extend: {
      colors: {
        "cb-emerald": "#1eb980", // 主翠色
        "cb-amber": "#f2a93b", // 主琥珀金
        "cb-ink": "#0b1525", // 深色背景
      },
    },
  },
...
| 特性     | tpmst    | poker-arena | callbreak-legend |
| -------- | -------- | ----------- | --------------- |
...
**主题路径**: `GuoLaiRen_PageBuilder::style/callbreak-legend`
