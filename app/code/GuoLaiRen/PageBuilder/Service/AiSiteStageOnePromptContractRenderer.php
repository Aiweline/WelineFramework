...
final class AiSiteStageOnePromptContractRenderer
{
    ...
    public function renderThemeContract(array $contract): array
    {
        return [
            ...
            '- Logo generation plan rule: write the website logo generation plan only into plan_json.theme.logo_generation with stage logo_generation, output_path plan_json.theme.logo_generation, and exactly four selectable options using asset_slot_id values plan:theme:logo_generation:option_1 through plan:theme:logo_generation:option_4. Do not emit legacy logo generation keys in shared_components, page blocks, or scope-level fields.',
