...
final class AiSiteStageOnePromptContractRenderer
{
    ...
    public function renderPageContract(array $contract, string $pageType): array
    {
        ...
        return [
            ...
            '- field_plan.sample and field_plan.implementation_note must not be generic filler text or prompt language, and must not start with write, rewrite, describe the/this block, describe the/this field, use this field, do not output, 围绕, 突出, 说明, 完善, or 优化. Visitor-facing form hint text such as "Describe your issue..." is allowed only as the final input hint itself; never name the HTML input hint attribute or call it a filler value.',
            '- Visible copy should use the Website content locale and reuse concrete nouns/actions from the brief and frozen page/block plan. Schema filler values, prompt instructions, validator wording, and internal blueprint labels must never become generated visitor HTML.',
    ...
    public function renderRepairContract(array $contract, array $validationReport): array
    {
        ...
        return [
            ...
            $this->noExtraExplanatoryFieldRule(),
            '- Rebuild the whole blocks array when any issue mentions blocks, visual_signature, image_intent, field_plan, or target count. Do not append a partial fixed block to the old page and do not leave any generic filler block behind.',
