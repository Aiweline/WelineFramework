...
final class AiSiteStageOnePromptContractRenderer
{
    ...
    public function renderThemeContract(array $contract): array
    {
        return [
            ...
            '- Logo generation plan rule: write the website logo generation plan only into plan_json.theme.logo_generation with stage logo_generation, asset_slot_id identity:website-logo, and output_path plan_json.theme.logo_generation. Do not emit legacy logo generation keys in shared_components, page blocks, or scope-level fields.',
