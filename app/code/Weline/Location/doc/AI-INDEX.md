...
4. 本文件：`app/code/Weline/Location/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Location/doc/README.md`
6. 只读取本次任务相关源码、配置和验证入口

## 模块身份

- 模块代码：`Weline_Location`
- 目录：`app/code/Weline/Location`
- Vendor：`Weline`
- Module：`Location`
...
入口/配置文件：
- `app/code/Weline/Location/etc/module.xml`
- `app/code/Weline/Location/composer.json`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Location> [operation]` 或对应 `w_query` 帮助。
