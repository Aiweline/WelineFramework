...
document.addEventListener('DOMContentLoaded', function () {
            ...
            html += `<div class="param-group ${isI18n ? 'i18n-field-group' : ''}">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <div class="param-actions">
                        ...
                        <button type="button" class="btn-reset-param" data-key="${key}" title="?????ù?>
    ...
    async function saveCurrentProperties() {
        ...
        btn.disabled = true;
        btn.innerHTML = '<span class="spinner-border spinner-border-sm"></span> ??ù?..';
    ...
    async function publishPreviewScope() {
        ...
        if (btn) {
            btn.disabled = true;
            btn.innerHTML = '<span class="spinner-border spinner-border-sm"></span> ùùùùùù...';
        }
