...
(function() {
    ...
    async function saveSelection(area, type, category, value) {
        try {
            ...
            const response = await WelineThemeBinQuery.request(config.saveSelectionUrl, {
                method: 'POST',
                body: formData
            });
    ...
    async function openParamsModal(type, category, value, area) {
        try {
            ...
            const response = await WelineThemeBinQuery.request(url.toString());
            const result = await response.json();
    ...
    async function saveParams() {
        ...
        try {
            const response = await WelineThemeBinQuery.request(config.saveFileParamsUrl, {
                method: 'POST',
                body: formData
            });
