        ...
        try {
            $response = match ($path) {
                ...
                '/theme/backend/theme-editor/check-lock' => $method === 'POST'
                    ...
                    : ($themeEditor ??= $this->createDirectThemeEditor())->getCheckLock(),
                ...
                '/theme/backend/theme-editor/scope-versions' => ($themeEditor ??= $this->createDirectThemeEditor())->getScopeVersionsPayload(),
                '/theme/backend/theme-editor/create-scope-draft' => ($themeEditor ??= $this->createDirectThemeEditor())->createScopeDraftPayload(),
                '/theme/backend/theme-editor/save-scope-version' => ($themeEditor ??= $this->createDirectThemeEditor())->saveScopeVersionPayload(),
                '/theme/backend/theme-editor/publish-scope-version' => ($themeEditor ??= $this->createDirectThemeEditor())->publishScopeVersionPayload(),
                '/theme/backend/theme-editor/restore-scope-defaults' => ($themeEditor ??= $this->createDirectThemeEditor())->restoreScopeDefaultsPayload(),
