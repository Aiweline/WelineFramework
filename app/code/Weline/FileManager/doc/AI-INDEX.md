...
4. 本文件：`app/code/Weline/FileManager/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/FileManager/doc/README.md`
...
- 模块代码：`Weline_FileManager`
- 目录：`app/code/Weline/FileManager`
- Vendor：`Weline`
- Module：`FileManager`
...
入口/配置文件：
- `app/code/Weline/FileManager/composer.json`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_FileManager> [operation]` 或对应 `w_query` 帮助。
