...
#[Index(name: 'idx_is_present', columns: ['is_present'], comment: '扫描存在状态索引')]
...
class AiAgent extends Model
{
    ...
    #[Col('varchar', 255, nullable: true, comment: '后台名称覆盖')]
    public const schema_fields_NAME_OVERRIDE = 'name_override';
