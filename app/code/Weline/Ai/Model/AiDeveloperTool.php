...
{
    public const table = 'ai_developer_tool';
    ...
    public function install(ModelSetup $setup, Context $context): void
    {
        if (!$setup->tableExist()) {
            $setup->createTable()
                ...
                ->addColumn(self::fields_NAME, TableInterface::column_type_VARCHAR, 255, 'not null', '工具名称')
                ->addColumn(self::fields_TYPE, TableInterface::column_type_VARCHAR, 100, 'not null', '工具类型')
