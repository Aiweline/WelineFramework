...
#[Table(comment: 'AI governed website style direction')]
#[Index(name: 'idx_ai_style_owner_code', columns: ['admin_user_id', 'code'], type: 'UNIQUE', comment: 'Unique style code per owner')]
#[Index(name: 'idx_ai_style_status', columns: ['status'], comment: 'Style status')]
#[Index(name: 'idx_ai_style_source_type', columns: ['source_type'], comment: 'Style source type')]
class AiStyle extends Model
{
    public const schema_table = 'ai_style';
    ...
    #[Col(type: 'int', primaryKey: true, autoIncrement: true, nullable: false, comment: 'Style ID')]
    public const schema_fields_ID = 'id';

    #[Col(type: 'int', nullable: false, default: 0, comment: 'Owner admin user ID, 0 for system/module styles')]
    ...
    #[Col(type: 'varchar', length: 160, nullable: false, default: '', comment: 'Style name')]
    public const schema_fields_NAME = 'name';

    #[Col(type: 'text', nullable: true, comment: 'Style description')]
    ...
    #[Col(type: 'int', nullable: false, default: 1, comment: 'Style version')]
