...
{
    public const MAX_CAPTURE_BYTES = 8_388_608;
     ...
     * @return array{exit_code:int,stdout:string,stderr:string,stdout_truncated:bool,stderr_truncated:bool,timed_out:bool,duration_ms:int}
     */
    public function run(
        array $argv,
        string $cwd,
