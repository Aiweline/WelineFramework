...
PLIST;
    ...
    public function status(): array
    {
        ...
        return [
            ...
            'raw_session_retention_seconds' => $this->config->duration('privacy.raw_session_ttl'),
            'index_gc_enabled' => (bool) $this->config->get('index.gc.enabled', true),
            'index_gc_retention_seconds' => $this->config->duration('index.gc.retention'),
            'index_gc_dry_run_seconds' => $this->config->duration('index.gc.dry_run_period'),
            'index_gc_quarantine_seconds' => $this->config->duration('index.gc.quarantine_period'),
        ];
    }
