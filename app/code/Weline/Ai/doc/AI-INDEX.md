...
4. 本文件：`app/code/Weline/Ai/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Ai/doc/README.md`
...
- `Api`：公开接口契约。跨模块调用优先找已发布 Interface 或 QueryProvider，不要直接依赖对方内部 Service/Model。 文件数：44
...
- 识别到 QueryProvider 相关 PHP 文件：Test/Unit/Controller/Frontend/AiLegacyExecutionBoundaryTest.php、Test/Unit/Controller/Frontend/ChatRuntimeRefactorTest.php、extends/module/Weline_Framework/Query/AiProviderAccountQueryProvider.php、extends/module/Weline_Framework/Query/AiQueryProvider.php；前端/跨模块读数据先查 query 帮助。
