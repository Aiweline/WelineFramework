...
const CANDIDATE_ROUTES = ["index","model","skill","adapter","manager","provider","style","defaultModel","defaultmodel","default_model","ai","config","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Ai 后台流程', () => {
  moduleCase(
    test,
    { module: MODULE, id: 'AI-SMOKE-001' },
