...
4. 本文件：`app/code/Weline/I18n/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/I18n/doc/README.md`
...
入口/配置文件：
- `app/code/Weline/I18n/etc/backend/menu.xml`
- `app/code/Weline/I18n/.module_config.json`
- `app/code/Weline/I18n/composer.json`

- `Api`：公开接口契约。跨模块调用优先找已发布 Interface 或 QueryProvider，不要直接依赖对方内部 Service/Model。 文件数：33
- `Config`：配置读取、合并或 schema 支撑。涉及作用域配置时同时读 SystemConfig 文档。 文件数：3
- `Console`：php bin/w 命令入口。新增/变更命令后用真实 CLI 验证。 文件数：6
- `Controller`：HTTP/后台/前台控制器入口。新增控制器后运行 setup:upgrade --route，同步路由。 文件数：16
...
- `Service`：模块内业务编排层。跨模块读取数据优先发布/使用 w_query。 文件数：25
...
- 识别到 QueryProvider 相关 PHP 文件：Taglib/LanguageSelect.php、Taglib/LanguageSwitcher.php、extends/module/Weline_Framework/Query/I18nAdminQueryProvider.php、extends/module/Weline_Framework/Query/I18nQueryProvider.php、extends/module/Weline_Framework/Query/LanguageSupportRequestAdminQueryProvider.php、extends/module/Weline_Framework/Query/LanguageSupportRequestQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/I18n/doc/AI翻译功能说明.md`
- `app/code/Weline/I18n/doc/AI翻译快速开始.md`
- `app/code/Weline/I18n/doc/AI自动翻译队列实施记录.md`
- `app/code/Weline/I18n/doc/README.md`
- `app/code/Weline/I18n/doc/event/AI翻译调用.md`
- `app/code/Weline/I18n/doc/event/收集翻译词.md`
