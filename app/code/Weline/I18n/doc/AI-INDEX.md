...
- `Service`：模块内业务编排层。跨模块读取数据优先发布/使用 w_query。 文件数：12
...
- 识别到 QueryProvider 相关 PHP 文件：extends/module/Weline_Framework/Query/I18nQueryProvider.php；前端/跨模块读数据先查 query 帮助。
