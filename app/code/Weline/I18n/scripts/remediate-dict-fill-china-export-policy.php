...
/**
 * Fast upsert China-export policy phrases dictionary fills (direct SQL, single broadcast).
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-china-export-policy.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-china-export-policy.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-china-export-policy.v1.php';
