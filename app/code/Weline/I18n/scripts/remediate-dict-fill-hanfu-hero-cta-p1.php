...
/**
 * Upsert Hanfu Hero CTA (UC-P1-04) dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-hanfu-hero-cta-p1.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-hanfu-hero-cta-p1.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-hanfu-hero-cta-p1.v1.php';
