...
/**
 * Upsert storefront /policy/accessibility dictionary fills (bulk SQL) + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-accessibility.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-accessibility.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-policy-accessibility.v1.php';
