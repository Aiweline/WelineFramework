...
/**
 * Upsert policy-copy-tone-soften dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-copy-tone-soften.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-copy-tone-soften.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-policy-copy-tone-soften.v1.php';
