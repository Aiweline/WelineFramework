...
/**
 * Upsert Shipping returns 1.1 + Theme trust-badge dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-shipping-returns-11-compliance.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-shipping-returns-11-compliance.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-shipping-returns-11-compliance.v1.php';
