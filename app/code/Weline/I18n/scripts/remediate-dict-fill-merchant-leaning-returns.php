 ...
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-merchant-leaning-returns.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-merchant-leaning-returns.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-merchant-leaning-returns.v1.php';
