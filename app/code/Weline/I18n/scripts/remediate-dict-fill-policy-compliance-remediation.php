...
/**
 * Upsert Theme policy-compliance remediation dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-compliance-remediation.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-policy-compliance-remediation.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-policy-compliance-remediation.v1.php';
