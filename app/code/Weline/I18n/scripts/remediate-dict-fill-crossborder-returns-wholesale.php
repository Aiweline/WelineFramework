...
/**
 * Upsert merchant-leaning returns policy dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-crossborder-returns-wholesale.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-crossborder-returns-wholesale.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-crossborder-returns-wholesale.v1.php';
