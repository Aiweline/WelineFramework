...
/**
 * Upsert soft-tone returns policy dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-soft-tone-returns.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-soft-tone-returns.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-soft-tone-returns.v1.php';
