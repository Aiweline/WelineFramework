...
/**
 * Fast upsert Checkout shipping empty-state dictionary fills (direct SQL, single broadcast).
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-checkout-shipping-empty.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-checkout-shipping-empty.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-checkout-shipping-empty.v1.php';
