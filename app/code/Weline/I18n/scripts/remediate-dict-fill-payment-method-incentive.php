...
/**
 * Upsert Payment method incentive dictionary fills + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-payment-method-incentive.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-payment-method-incentive.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-payment-method-incentive.v1.php';
