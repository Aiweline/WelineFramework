...
/**
 * Upsert mail shell labels + brand service_hours + topics samples + publishLocale.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-mail-shell-brand-hours.php --dry-run
...
$pack = require __DIR__ . '/data/dict-fill-mail-shell-brand-hours.v1.php';
