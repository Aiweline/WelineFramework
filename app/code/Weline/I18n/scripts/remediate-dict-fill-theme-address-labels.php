...
/**
 * Upsert Theme Address Taglib helper labels + publishLocale.
 * Dual DB: MySQL (production Hanfu) + PostgreSQL (local clones).
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-theme-address-labels.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/I18n/scripts/remediate-dict-fill-theme-address-labels.php --apply
 */
...
$pack = require __DIR__ . '/data/dict-fill-theme-address-labels.v1.php';
