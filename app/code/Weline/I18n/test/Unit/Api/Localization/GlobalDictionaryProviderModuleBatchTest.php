...
final class GlobalDictionaryProviderModuleBatchTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->db->pdo->exec("INSERT INTO dictionary VALUES ('A','Translated A','en_US','Weline_A'), ('B','Translated B','en_US','Weline_B'), ('Same','Same','en_US','Weline_B'), ('Blank','','en_US','Weline_A'), ('Other','Other module','en_US','Weline_C'), ('A','French A','fr_FR','Weline_A')");
    ...
    public function testOneSqlReturnsIndependentModuleMapsAndKeepsWordsSemantics(): void
    {
        ...
        self::assertSame(array_merge(...array_values($maps)), $provider->words('en_US', ['Weline_A', 'Weline_B', 'Weline_Empty']));
