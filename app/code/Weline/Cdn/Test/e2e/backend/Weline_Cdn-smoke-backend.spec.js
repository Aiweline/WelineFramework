/**
 * Weline_Cdn：诚实路由 smoke + 后台真实交互 flow（Wave2/3 假用例整治）
 *
...
const CANDIDATE_ROUTES = ["domain","apiRules","apirules","api_rules","rules","attackLog","attacklog","attack_log","account","warmup","api/cdn/accounts","api/cdn/providers","cdn","index","config","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Cdn 后台流程', () => {
  moduleCase(
    test,
