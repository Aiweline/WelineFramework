...
- ✅ **多适配器支持**：支持多种 CDN 提供商，通过适配器模式轻松扩展
...
1. 创建适配器类，实现 `Weline\Cdn\Api\AdapterInterface`：

```php
<?php
namespace YourModule\Cdn\Adapter;
...
2. 放置适配器文件：`YourModule/Cdn/Adapter/YourAdapter.php`
