...
dispatch("Weline_Cdn::request", [
    "action" => "purge_all|purge_urls|purge_scope|push_rule|check_capability",
...
action 类型说明：
- purge_all: 清理当前网站配置主机或指定主机的缓存
- purge_urls: 清理指定URL缓存，data.urls = [url1, url2]
- purge_scope: 按公开基址清理 Host 或 URL Prefix，data.urls = [baseUrl1, baseUrl2]
