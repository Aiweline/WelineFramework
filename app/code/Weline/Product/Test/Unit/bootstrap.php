...
/**
 * Minimal bootstrap for Weline_Product unit tests.
 */
...
// Framework path packages may not yet list a brand-new module; ensure PSR-4 for tests.
spl_autoload_register(static function (string $class): void {
    $prefix = 'Weline\\Product\\';
