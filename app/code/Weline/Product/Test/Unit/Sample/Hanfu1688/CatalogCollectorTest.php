...
final class CatalogCollectorTest extends TestCase
{
    ...
    public function testStagnantListingDriftIsToleratedWithResidualGap(): void
    {
        $http = new PublicHttpClient(
            fn(string $url): array => ['status' => 200, 'headers' => [], 'body' => $this->factoryHtml()],
            static fn(int $microseconds): null => null,
        ...
        self::assertTrue($snapshot['listing_total_drift_tolerated']);
        self::assertSame(1, $snapshot['listing_total_gap']);
        self::assertSame(2, $snapshot['terminal_proof']['unique_offer_count']);
        self::assertSame(3, $snapshot['terminal_proof']['expected_total']);
    }

    public function testEveryOfferAttemptsDesktopDetailDespiteEarlierPublicChallenges(): void
    {
        $desktopFetches = 0;
        $mobileFetches = 0;
        $http = new PublicHttpClient(
        ...
        self::assertSame(4, $desktopFetches);
        self::assertSame(4, $mobileFetches);
        self::assertSame(0, $snapshot['terminal_proof']['detail_fallback_count']);
        self::assertSame(0, $snapshot['terminal_proof']['detail_requests_skipped_after_challenge']);
        self::assertSame(
    ...
    public function testPageLimitDuringRecoveryToleratesDriftWhenOffersExist(): void
    {
        $http = new PublicHttpClient(
            fn(string $url): array => ['status' => 200, 'headers' => [], 'body' => $this->factoryHtml(6)],
            static fn(int $microseconds): null => null,
            0,
        );
        $collector = new CatalogCollector(
            ...
            new FactoryPageParser(),
            new OfferDetailParser(),
            function (string $memberId, int $page): array {
                ...
                return [
                    ...
                    'data' => [
                        ...
                        'pageSize' => '2',
                        'data' => [
                            $this->listingOffer((string) (($page * 2) - 1)),
                            $this->listingOffer((string) ($page * 2)),
                        ],
                    ],
                ];
            },
        ...
        $snapshot = $collector->collect([
            ...
            'factory_url' => 'https://www.1688.com/factory/b2b-123.html',
            'shop_url' => 'https://shop123.1688.com',
        ], 2, static fn(array $listing): bool => false);

        self::assertTrue($snapshot['listing_total_drift_tolerated']);
        self::assertGreaterThan(0, $snapshot['terminal_proof']['unique_offer_count']);
        self::assertLessThan(6, $snapshot['terminal_proof']['unique_offer_count']);
        self::assertSame(6, $snapshot['terminal_proof']['expected_total']);
    }
