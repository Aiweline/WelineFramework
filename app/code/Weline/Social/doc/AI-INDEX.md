...
4. 本文件：`app/code/Weline/Social/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Social/doc/README.md`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Social> [operation]` 或对应 `w_query` 帮助。
