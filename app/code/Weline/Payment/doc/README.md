...
- `Weline_Payment::frontend::checkout::payment-methods-before` - 支付方式选择区域之前
- `Weline_Payment::frontend::checkout::payment-methods-after` - 支付方式选择区域之后
- `Weline_Payment::frontend::checkout::payment-form-before` - 支付表单之前
- `Weline_Payment::frontend::checkout::payment-form-after` - 支付表单之后
- `Weline_Payment::frontend::checkout::payment-result` - 支付结果展示
