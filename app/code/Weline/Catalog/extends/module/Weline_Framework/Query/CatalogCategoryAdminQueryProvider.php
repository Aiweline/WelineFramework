...
final class CatalogCategoryAdminQueryProvider implements QueryProviderInterface
{
        ...
        return [
            ...
            'operations' => [
                ...
                $this->operation('categoryAdminSave', (string)__('保存分类'), 'write', [
                    ...
                    ['name' => 'google_taxonomy_id', 'type' => 'string', 'required' => false, 'max_length' => 32],
                    ['name' => 'image', 'type' => 'string', 'required' => false, 'max_length' => 512],
    ...
    private function categoryAdminSave(array $params): mixed
    {
        return AdminControllerBridge::invoke(
            ...
            [
                ...
                'google_taxonomy_id' => trim((string)($params['google_taxonomy_id'] ?? '')),
    ...
    /** @param array<string,mixed> $params */
    private function categoryAdminSaveDisplay(array $params): mixed
    {
        return AdminControllerBridge::invoke(
            Category::class,
            ['postDisplaySave'],
