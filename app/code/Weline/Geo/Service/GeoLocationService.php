...
use Weline\Geo\Service\Provider\GeoProviderInterface;
use Weline\Geo\Service\Provider\LocalProvider;
use Weline\Geo\Service\Provider\IpApiComProvider;
use Weline\Geo\Service\Provider\GeojsProvider;
use Weline\Geo\Service\Provider\IpwhoisProvider;
use Weline\Geo\Service\Provider\IpinfoProvider;
use Weline\Geo\Service\Provider\IpapiCoProvider;
...
class GeoLocationService
{
    ...
    {
        $this->config = Env::module_env('Weline_Geo', 'geo') ?? [];
     ...
     * @return GeoProviderInterface|null
     */
    private function createProvider(string $class, array $config): ?GeoProviderInterface
    {
