...
const CANDIDATE_ROUTES = ["feed","platform","push","geo","index","config","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Geo 后台流程', () => {
  moduleCase(
    test,
