...
(function() {
    ...
    Object.assign(window.WelineModulesConfig.modules, {
        ...
        youMayLike: {
            ...
            paths: ["/Weline/Product/view/statics/js/widgets/you-may-like.js"],
            globalVar: null,
        ...
        productStickyPurchase: {
            ...
            paths: ["/Weline/Product/view/statics/js/widgets/product-sticky-purchase.js?v=20260913-sticky-atc4"],
            globalVar: null,
        ...
        b2bSellingMode: {
            ...
            paths: ["/Weline/B2B/view/statics/js/checkout-tob.js?v=20260914-goods-sync1", "/Weline/B2B/view/statics/js/selling-mode.js?v=20260914-no-cart-chooser"],
        ...
        b2bCheckoutTob: {
            ...
            paths: ["/Weline/B2B/view/statics/js/checkout-tob.js?v=20260914-goods-sync1"],
        ...
        b2bOrderChat: {
            ...
            paths: ["/Weline/B2B/view/statics/js/order-chat-accordion.js?v=20260912-order-chat4"],
        ...
        affiliateProductShare: {
            ...
            paths: ["/Weline/Affiliate/view/statics/js/affiliate-product-share.js?v=20260914-panel-share-url"],
