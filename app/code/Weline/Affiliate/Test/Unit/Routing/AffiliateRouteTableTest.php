...
namespace Weline\Affiliate\Test\Unit\Routing;
...
final class AffiliateRouteTableTest extends TestCase
{
    ...
    public function testFrontendRouteTableContainsAffiliateRoutes(): void
    {
        ...
        $this->assertSame('Weline_Affiliate', $routes['affiliate']['module'] ?? null);
        $this->assertSame('Weline_Affiliate', $routes['affiliate/redirect']['module'] ?? null);
    }
    ...
    public function testBackendRouteTableContainsAffiliateAdminRoutes(): void
    {
        ...
        $this->assertSame('Weline_Affiliate', $routes['affiliate/backend/affiliate']['module'] ?? null);
        $this->assertSame('Weline_Affiliate', $routes['affiliate/backend/affiliate/save::POST']['module'] ?? null);
    }
