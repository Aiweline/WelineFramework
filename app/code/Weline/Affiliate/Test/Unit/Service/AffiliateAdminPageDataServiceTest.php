...
use Weline\Affiliate\Service\AffiliateScopeFormDataService;
...
class AffiliateAdminPageDataServiceTest extends TestCase
{
    ...
    public function testEditingRecordIsNormalizedBeforeSummaryCanClearSharedModel(): void
    {
        ...
        $service = new class($affiliateService, $this->createScopeFormDataServiceMock(), $holder) extends AffiliateAdminPageDataService {
            public function __construct(
                AffiliateService $affiliateService,
                AffiliateScopeFormDataService $scopeFormDataService,
                private readonly object $holder
            ) {
                parent::__construct($affiliateService, $scopeFormDataService);
            }
    ...
    private function createScopeFormDataServiceMock(): AffiliateScopeFormDataService
    {
        $scopeFormDataService = $this->createMock(AffiliateScopeFormDataService::class);
        $scopeFormDataService->method('build')->willReturn([
            'websiteOptionsJson' => '[]',
            'storeOptionsJson' => '[]',
            'channelOptionsJson' => '[]',
        ...
        $scopeFormDataService->method('buildScopeLabel')->willReturn('Global scope');

        return $scopeFormDataService;
    }

    private function createService(AffiliateService $affiliateService): AffiliateAdminPageDataService
    {
        return new class($affiliateService, $this->createScopeFormDataServiceMock()) extends AffiliateAdminPageDataService {
            public function __construct(AffiliateService $affiliateService, AffiliateScopeFormDataService $scopeFormDataService)
            {
                parent::__construct($affiliateService, $scopeFormDataService);
            }
