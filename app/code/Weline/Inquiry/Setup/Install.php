...
final class Install implements InstallInterface
{
    ...
    private function ensureMotorcycleDealerQuote(): void
    {
        ...
        $draft = $service->saveDraft([
            ...
            'code' => 'motorcycle-dealer-quote',
            'name' => 'Motorcycle dealer quote',
            ...
            'schema' => ['fields' => [
                ...
                ['key' => 'business_type', 'type' => 'select', 'required' => true, 'options' => [
                    ['value' => 'dealer'],
                    ['value' => 'distributor'],
                    ['value' => 'oem_odm'],
                    ['value' => 'other'],
                ]],
                ['key' => 'models', 'type' => 'textarea', 'required' => true],
                ['key' => 'annual_volume', 'type' => 'number', 'required' => false],
                ['key' => 'message', 'type' => 'textarea', 'required' => false],
            ]],
            'translations' => [
                'en_US' => [
                    'title' => 'Request a dealer quotation',
                    'description' => 'Tell us the motorcycle models and market you serve.',
                    'submit_label' => 'Request quotation',
                    'success_message' => 'Thank you. Our export team will contact you shortly.',
                    'fields' => [
                        ...
                        'models' => ['label' => 'Interested models'],
                        'annual_volume' => ['label' => 'Expected annual volume'],
                        'message' => ['label' => 'Additional requirements'],
                    ],
                ],
                'zh_Hans_CN' => [
                    'title' => '获取经销商报价',
                    'description' => '告诉我们您关注的车型与目标市场。',
                    'submit_label' => '提交报价需求',
                    'success_message' => '感谢您的咨询，出口团队将尽快联系您。',
                    'fields' => [
                        'full_name' => ['label' => '姓名'],
                        'email' => ['label' => '商务邮箱'],
                        'company' => ['label' => '公司名称'],
