...
#[Acl('Weline_Inquiry::root', '询盘表单', 'mdi-form-select', '管理询盘表单', 'Weline_Backend::cms_group')]
final class Inquiry extends BackendController
{
    ...
    #[Acl('Weline_Inquiry::list', '询盘表单列表', 'mdi-format-list-bulleted', '查看询盘表单', 'Weline_Inquiry::root')]
    ...
    #[Acl('Weline_Inquiry::manage', '编辑询盘表单', 'mdi-pencil', '编辑询盘字段与翻译', 'Weline_Inquiry::root')]
    ...
    #[Acl('Weline_Inquiry::publish', '发布询盘表单', 'mdi-publish', '发布询盘表单版本', 'Weline_Inquiry::root')]
    public function postPublish(): string { return ''; }

    /** ACL resource for the trusted custom-JS Widget parameter. */
    #[Acl('Weline_Inquiry::trusted_js', '询盘可信自定义脚本', 'mdi-code-braces', '编辑已受系统开关控制的可信脚本', 'Weline_Inquiry::root')]
