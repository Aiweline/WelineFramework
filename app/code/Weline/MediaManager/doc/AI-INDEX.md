...
4. 本文件：`app/code/Weline/MediaManager/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/MediaManager/doc/README.md`
...
- 模块代码：`Weline_MediaManager`
- 目录：`app/code/Weline/MediaManager`
- Vendor：`Weline`
- Module：`MediaManager`
...
入口/配置文件：
- `app/code/Weline/MediaManager/etc/backend/menu.xml`
...
- 识别到 QueryProvider 相关 PHP 文件：Controller/Backend/AiDraw.php、extends/module/Weline_Framework/Query/MediaManagerAssetQueryProvider.php、extends/module/Weline_Framework/Query/MediaManagerQueryProvider.php；前端/跨模块读数据先查 query 帮助。
...
- `app/code/Weline/MediaManager/doc/功能现状.md`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_MediaManager> [operation]` 或对应 `w_query` 帮助。
