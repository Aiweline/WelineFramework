...
class MimeTypes
{
    ...
    private static array $safeUploadExtensions = [
        ...
        'zip', 'rar', 'gz', 'tar', '7z', 'mp3', 'wav', 'ogg', 'm4a', 'aac', 'flac', 'opus',
        'wma', 'oga', 'weba', 'mp4', 'webm', 'avi',
    ...
    private static array $extensionMap = [
        ...
        // libmagic often reports AAC-in-MP4 (.m4a) as video/mp4 or application/mp4.
        'm4a'  => [
            'audio/mp4',
            'audio/x-m4a',
            'audio/m4a',
