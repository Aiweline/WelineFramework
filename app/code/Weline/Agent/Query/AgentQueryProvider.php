 ...
 * 
 * 使用示例：
 *   w_query('agent', 'getRole', ['code' => 'assistant'])
 *   w_query('agent', 'getActiveRoles', [])
 *   w_query('agent', 'getSkills', ['category' => 'filesystem'])
 *   w_query('agent', 'getSession', ['id' => 1])
 */
class AgentQueryProvider implements QueryProviderInterface
{
    ...
    public function getDescriptor(): array
    {
        return [
            'provider' => 'agent',
            'name' => '智能体查询',
            'description' => '提供智能体角色管理、技能系统、会话管理、任务调度等查询能力',
            'module' => 'Weline_Agent',
            'operations' => [
                [
                    'name' => 'getRole',
