...
{
    public const schema_table = 'weline_agent_schedule';
    ...
    private ?AgentRole $roleModel = null;
    ...
    public function getRole(): ?AgentRole
    {
        if ($this->roleModel === null && $this->getData(self::schema_fields_ROLE_ID)) {
            $this->roleModel = (new AgentRole())->load($this->getData(self::schema_fields_ROLE_ID));
        }
