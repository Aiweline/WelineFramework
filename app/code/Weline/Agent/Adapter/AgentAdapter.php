...
namespace Weline\Agent\Adapter;

use Weline\Ai\Interface\ScenarioAdapterInterface;

/**
 * Default Agent scenario adapter.
 */
class AgentAdapter implements ScenarioAdapterInterface
{
    ...
    {
        return __('默认适配器：基于角色的智能体对话，含工具、记忆上下文与安全护栏。');
    }
