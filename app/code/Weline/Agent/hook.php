<?php
/**
 * Weline_Agent 模块 Hook 规约文件
 *
 * 本文件定义了 Weline_Agent 模块提供的所有 Hook 扩展点
 * Hook 命名格式：{ModuleName}::{area}::{type}::{component}::{position}
 */

return [
    // ==================== 聊天控制台侧边栏 ====================
    'Weline_Agent::backend::partials::chat-sidebar::content' => [
        'name' => __('聊天侧边栏扩展'),
    ...
    // ==================== 聊天消息工具栏 ====================
    'Weline_Agent::backend::partials::chat-message-tools::content' => [
        'name' => __('消息工具栏扩展'),
