...
final class ContinuePayUrlBuilderTest extends TestCase
{
    public function testBuildsCapabilityUrlWhenSubmittedTokenExists(): void
    {
        ...
        $store->put('qt_abc', [
            ...
            'submitted_result' => ['order_uuids' => ['ord-cap-1']],
        ...
        self::assertStringContainsString('checkout_token=qt_abc', $result['continue_pay_url']);
        self::assertStringContainsString('order_uuid=ord-cap-1', $result['continue_pay_url']);
        self::assertStringStartsWith('https://shop.example.test/checkout/success?', $result['continue_pay_url']);
    }
