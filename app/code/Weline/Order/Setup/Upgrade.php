...
final class Upgrade implements UpgradeInterface
{
    ...
    public function setup(Setup $setup, Context $context): void
    {
        ...
        $this->seedLayoutSlotDefaults('cart', ['cart-summary-note']);
        $this->seedLayoutSlotDefaults('checkout', ['checkout-summary-note']);
    }
        ...
        try {
            ...
            foreach ($themes as $themeRow) {
                ...
                $layoutService->publishLayout(
                    ...
                    true,
                    [
                        'reason' => 'order-notice slot default injection publish',
                        'actor' => 'system:Weline_Order:Upgrade',
                    ],
                );
            }
        } catch (\Throwable $e) {
