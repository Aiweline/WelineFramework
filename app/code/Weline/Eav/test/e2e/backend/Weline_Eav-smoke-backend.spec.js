...
const CANDIDATE_ROUTES = ["attribute/dependence","attribute","manager","api/group","api/attribute","api/set","api/tree","api/entity","entity","attribute/option/search","eav","index","config","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Eav 后台流程', () => {
  moduleCase(
    test,
    { module: MODULE, id: 'EAV-SMOKE-001' },
