...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		start = function(elFinder, editors, config) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('/static/Weline/default/Weline/ElFinderFileManager/view/statics/jquery-ui.min.css');
	...
	require.config({
		baseUrl : '/static/Weline/default/Weline/ElFinderFileManager/view/statics/js',
		paths : {
			'jquery'   : '/static/Weline/default/Weline/ElFinderFileManager/view/statics/jquery.min',
			'jquery-ui': '/static/Weline/default/Weline/ElFinderFileManager/view/statics/jquery-ui.min',
