...
PHP;
            ...
            $html[] = '  window.WelineSmartDropdown.mount(trigger, dropdown, { minWidth: 260, preferredHeight: 320, zIndex: 4200 });';
            ...
            $html[] = '  close();';
            $html[] = '});';
            $html[] = 'window.addEventListener("resize", function(){ if (open) window.WelineSmartDropdown.mount(trigger, dropdown, { minWidth: 260, preferredHeight: 320, zIndex: 4200 }); });';
