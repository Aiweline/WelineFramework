...
- `Api`：公开接口契约。跨模块调用优先找已发布 Interface 或 QueryProvider，不要直接依赖对方内部 Service/Model。 文件数：37
...
- 识别到 QueryProvider 相关 PHP 文件：Api/Authorization/BackendObjectAuthorizationGuardInterface.php、Observer/CollectFrameworkAuthorizationCatalog.php、Service/ResourceAuthorizationService.php、extends/module/Weline_Framework/Query/AclAdminQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/Acl/doc/README.md`
- `app/code/Weline/Acl/doc/event/无权限访问重定向前.md`
- `app/code/Weline/Acl/doc/event/站级能力天花板.md`
- `app/code/Weline/Acl/doc/event/角色检查.md`
- `app/code/Weline/Acl/doc/multi-resource-catalog.md`
- `app/code/Weline/Acl/doc/website-entitlement-events.md`
- `app/code/Weline/Acl/doc/功能现状.md`
