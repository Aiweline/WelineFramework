...
class DomainSelect implements TaglibInterface
{
    ...
    public static function callback(): callable
    {
        return function ($tag_key, $config, $tag_data, $attributes) {
            ...
            $html[] = '          addressList.push("https://" + wwwDomain);';
            $html[] = '          addressList.push("https://" + rootDomain);';
            $html[] = '          addressList.push("http://" + wwwDomain);';
            $html[] = '          addressList.push("http://" + rootDomain);';
            $html[] = '        }';
            $html[] = '      });';
