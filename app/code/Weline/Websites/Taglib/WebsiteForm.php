...
class WebsiteForm implements TaglibInterface
{
    ...
    public static function callback(): callable
    {
        return function ($tag_key, $config, $tag_data, $attributes) {
            ...
            $html[] = '            <?php';
            $html[] = '            $__wfs_default_currency_selector_id = (string)($Taglib__id . \'_default_currency_selector\');';
            $html[] = '            $__wfs_currency_codes_selector_id = (string)($Taglib__id . \'_currency_codes_selector\');';
            $html[] = '            $__wfs_default_currency_input_id = (string)($Taglib__id . \'_default_currency\');';
            $html[] = '            $__wfs_currency_codes_input_id = (string)($Taglib__id . \'_currency_codes\');';
            $html[] = '            $__wfs_default_currency_value = (string)($website[\'default_currency\'] ?? \'\');';
            $html[] = '            $__wfs_selected_currencies = is_array($selectedCurrencies ?? null) ? $selectedCurrencies : [];';
            $html[] = '            if ($__wfs_default_currency_value !== \'\' && !in_array($__wfs_default_currency_value, $__wfs_selected_currencies, true)) {';
            $html[] = '              $__wfs_selected_currencies[] = $__wfs_default_currency_value;';
            $html[] = '            }';
            $html[] = '            $__wfs_readonly_currencies = $__wfs_default_currency_value !== \'\' ? [$__wfs_default_currency_value] : [];';
            $html[] = '            ?>';
            $html[] = '            <w:currency:select id="__wfs_default_currency_selector_id" name="default_currency" input-id="__wfs_default_currency_input_id" value="__wfs_default_currency_value" currencies="currencies" allow-empty="true" data-w-width="full" />';
            ...
            $html[] = '            <w:currency:select id="__wfs_currency_codes_selector_id" name="currency_codes[]" input-id="__wfs_currency_codes_input_id" value="__wfs_selected_currencies" readonly-values="__wfs_readonly_currencies" currencies="currencies" multiple="true" data-w-width="full" />';
            $html[] = '            <div class="w-field__hint"><lang>点击选择关联货币，默认货币不可取消</lang></div>';
            $html[] = '          </div>';
            $html[] = '          <div style="--w-span:6;--w-mb:var(--weline-space-4);">';
