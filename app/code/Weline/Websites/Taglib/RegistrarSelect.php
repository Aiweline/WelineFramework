...
class RegistrarSelect implements TaglibInterface
{
    ...
    public static function callback(): callable
    {
        return function ($tag_key, $config, $tag_data, $attributes) {
            ...
            $html[] = 'function positionDropdown(){ window.WelineTaglibFloatingDropdown.mount(trigger, dropdown, { minWidth: 280, maxWidth: 350, preferredHeight: 300, zIndex: 4200, gap: 4 }); }';
