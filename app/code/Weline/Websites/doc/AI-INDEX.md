...
- `Model`：ORM 数据模型与字段 schema。字段结构用 #[Col]/#[Index] 后执行 setup:upgrade。 文件数：22
...
- `Taglib`：模板标签扩展。改前读 Weline_Taglib 与 Theme 文档。 文件数：4
...
- 识别到 QueryProvider 相关 PHP 文件：extends/module/Weline_Framework/Query/WebsitesQueryProvider.php；前端/跨模块读数据先查 query 帮助。
