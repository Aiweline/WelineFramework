...
const CANDIDATE_ROUTES = ["user","config","integration","api","index","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Api 后台流程', () => {
  moduleCase(
    test,
