...
return [
    ...
    'cart-progress' => [
        'name' => '购物车满额进度',
        'description' => '购物车摘要满额进度条 + 可选新客礼入口。',
        'type' => 'content',
        'code' => 'cart-progress',
        'area' => 'frontend',
        'template' => 'Weline_Marketing::templates/frontend/widgets/cart-progress.phtml',
        'page_layouts' => ['cart'],
        'position' => ['summary'],
        'slot' => 'cart-summary-discount',
        'supports' => [
        ...
        'params' => [
            'title' => ['default' => '满额进度', 'type' => 'string', 'label' => '标题'],
            'threshold' => ['default' => 99, 'type' => 'number', 'label' => '满额门槛'],
            'currency' => ['default' => '', 'type' => 'string', 'label' => '货币码'],
            'show_welcome' => ['default' => true, 'type' => 'bool', 'label' => '显示新客礼入口'],
            'welcome_label' => ['default' => '新客礼', 'type' => 'string', 'label' => '新客礼文案'],
            'welcome_url' => ['default' => '/account/register', 'type' => 'string', 'label' => '新客礼链接'],
        ],
    ],
    ...
    'welcome-gift' => [
        'name' => '注册见面礼入口',
        'description' => '生命周期欢迎启用时展示的注册领取入口。',
        'type' => 'content',
        'code' => 'welcome-gift',
        'area' => 'frontend',
        'template' => 'Weline_Marketing::templates/frontend/widgets/welcome-gift.phtml',
        'page_layouts' => ['homepage', 'cart'],
        'position' => ['content'],
        'slot' => 'content',
        'supports' => ['welcome-gift', 'marketing'],
        'params' => [],
    ],
];
