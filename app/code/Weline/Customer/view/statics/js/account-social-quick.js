  ...
  function init(root, presetCfg, options) {
    ...
    function startPrompt() {
      ...
      function ensureFallbackStyles() {
        ...
        style.textContent = [
          /* 面板走水墨/主题 Token；Google/Facebook 钮保留官方识别色（OAuth 约定） */
          '.weline-social-quick-bar{position:fixed;z-index:2147483000;right:var(--weline-space-4,16px);bottom:var(--weline-space-4,16px);',
          'box-sizing:border-box;width:min(280px,calc(100vw - 32px));',
          'background:var(--color-bg-dark,var(--weline-chrome-bg-dark,#1f2124));',
          'color:var(--color-text-on-dark,var(--color-text-light,#f7f4ef));',
          'border:1px solid var(--color-border-strong,rgba(212,207,197,.28));',
          'border-radius:var(--weline-radius-lg,12px);',
          'box-shadow:var(--weline-theme-shadow-lg,0 12px 28px rgba(28,28,28,.22));',
          'padding:var(--weline-space-3,12px);',
          'font:600 13px/1.35 var(--weline-layout-font-family-body,system-ui,-apple-system,Segoe UI,sans-serif)}',
          ...
          'color:var(--color-text-on-dark,inherit)}',
          ...
          'gap:12px;width:100%;min-height:44px;box-sizing:border-box;',
          'border-radius:var(--weline-radius-md,10px);',
          'padding:10px 14px;cursor:pointer;font:600 14px/1.2 inherit;text-align:left}',
          ...
          '.weline-social-quick-bar__btn--google{background:var(--color-bg-primary,#fffefa);color:var(--color-text,#1c1c1c);',
          'border:1px solid var(--color-border-default,#d4cfc5)}',
          '.weline-social-quick-bar__btn--google:hover{background:var(--color-surface-hover,#f0ebe3)}',
          ...
          'border-radius:var(--weline-radius-sm,6px);background:transparent;',
          'color:var(--color-text-on-dark-muted,#d4cfc5);cursor:pointer;font-size:18px;line-height:1}',
          '.weline-social-quick-bar__close:hover{color:var(--color-text-on-dark,#f7f4ef);background:rgba(255,255,255,.08)}',
          ...
          'background:var(--color-bg-secondary,var(--weline-theme-surface-subtle,#ede9e1));',
          'color:var(--color-text-primary,var(--weline-theme-text,#1c1c1c));',
          'border:1px solid var(--color-border-light,var(--weline-theme-border-color,#e8e4dc));',
