...
- 识别到 QueryProvider 相关 PHP 文件：Test/Unit/I18n/AccountProfileMessageI18nContractTest.php、Test/Unit/Query/AccountQueryProviderCaptchaTest.php、Test/Unit/Query/AccountSidebarQueryProviderContextTest.php、extends/module/Weline_Framework/Query/AccountQueryProvider.php、extends/module/Weline_Framework/Query/CustomerAdminQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/Customer/doc/README.md`
- `app/code/Weline/Customer/doc/event/account/客户账户登录后.md`
...
- `app/code/Weline/Customer/doc/功能现状.md`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Customer> [operation]` 或对应 `w_query` 帮助。
