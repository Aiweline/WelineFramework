...
namespace Weline\Hook\Extends\Module\Weline_Framework\Query;

use Weline\Framework\Manager\ObjectManager;
use Weline\Framework\Service\Query\Provider\QueryProviderInterface;

class HookAdminQueryProvider implements QueryProviderInterface
{
