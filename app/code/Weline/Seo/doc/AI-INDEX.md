...
- `Setup`：安装/升级装配（数据种子可写；字段 CRUD 仍走模型 attribute）。不要手改 generated。 文件数：2
...
- `app/code/Weline/Seo/doc/AI优化实时控制中心.md`
...
- `app/code/Weline/Seo/doc/Sitemap衍生与Website集成说明.md`
- `app/code/Weline/Seo/doc/StoreMode硬门禁.md`
...
- `app/code/Weline/Seo/doc/event/domain/website_account_bind.md`
