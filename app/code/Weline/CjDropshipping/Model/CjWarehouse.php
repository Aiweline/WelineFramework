...
namespace Weline\CjDropshipping\Model;
...
/**
 * CJ 远程仓缓存表（Provider 私有；由 pullWarehouses 写入）。
 */
#[Table(comment: 'CJ Dropshipping warehouse cache')]
#[Index(name: 'uk_cj_wh_ext', columns: ['external_id'], type: 'UNIQUE')]
class CjWarehouse extends Model
{
    public const schema_table = 'weline_cj_warehouse';
    public const schema_primary_key = 'id';

    #[Col('int', 11, primaryKey: true, autoIncrement: true, nullable: false, comment: 'ID')]
    public const schema_fields_ID = 'id';

    #[Col('varchar', 64, nullable: false, comment: 'CJ warehouse id (areaId or storageId)')]
    ...
    #[Col('text', nullable: true, comment: 'Raw JSON snapshot')]
    public const schema_fields_RAW_JSON = 'raw_json';
