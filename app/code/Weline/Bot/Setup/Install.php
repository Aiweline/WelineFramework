...
class Install implements InstallInterface
{
    ...
    {
        /** @var \Weline\Bot\Model\BotRole $roleModel */
        $roleModel = \Weline\Framework\Manager\ObjectManager::getInstance(\Weline\Bot\Model\BotRole::class);
     ...
     * 注册 Bot 场景适配器
     */
    private function registerBotAdapters(): void
    {
        // TODO: migrate legacy raw SQL seed to model API
        return;
