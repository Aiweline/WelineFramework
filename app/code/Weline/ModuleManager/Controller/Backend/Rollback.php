...
final class Rollback extends BackendController
{
    ...
    #[Acl('Weline_ModuleManager::module_rollback_targets', '查看回滚目标', 'list', '查看可用目标版本')]
    ...
    #[Acl('Weline_ModuleManager::module_rollback_plan', '创建回滚预检', 'search', '生成只读级联回滚计划')]
    ...
    #[Acl('Weline_ModuleManager::module_rollback_start', '执行模块回滚', 'play', '启动已确认的持久化回滚任务')]
    ...
    #[Acl('Weline_ModuleManager::module_rollback_operation', '查看回滚任务', 'clock', '查看回滚阶段、备份和补偿结果')]
