...
namespace Weline\ModuleManager\Test\Unit\Taglib;

use PHPUnit\Framework\TestCase;

final class ModuleSelectThemeTokensContractTest extends TestCase
{
    public function testModuleSelectStylesPreferThemeTokensOverHardcodedLightPalette(): void
    {
        $path = dirname(__DIR__, 3) . '/Taglib/ModuleSelect.php';
