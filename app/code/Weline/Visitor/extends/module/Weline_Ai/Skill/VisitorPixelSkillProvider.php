...
- PageBuilder injects `website_id`, `page_type`, `block_key`, `plan_revision`, `content_fingerprint`, `experiment_id`, `variant`, and canonical path at render time. Never invent, copy, hard-code, or generate any of these authority fields.
- The AI chooses meaningful event names only. The Visitor runtime owns page exposure, one-second 50% block impressions, version attribution, and anonymous session identity.
