...
class FrameworkAdminQueryProvider implements QueryProviderInterface
{
    public function getProviderName(): string
    {
        return 'framework_admin';
    }
    ...
    {
        return [
            'provider' => 'framework_admin',
            'name' => 'Weline_Framework admin bridge',
    ...
    private function adminRequest(array $params): mixed
    {
        ...
        $ns = 'Weline\Framework\Controller';
