...
return [
    ...
    // ========== 国际化事件 ==========
    'Framework_phrase::get_words_file' => [
        'name' => __('获取翻译文件'),
...
>>>>>>> dev-new
    ...
    'Framework_Module::module_upgrade' => [
        'name' => __('模块升级'),
...
>>>>>>> dev-new
    ...
    'Framework_Template::after_tags_config' => [
        'name' => __('标签配置后'),
    ...
    // ========== 应用控制器事件 ==========
    'Framework_App::backend_controller_init_before' => [
        'name' => __('后端控制器初始化前'),
        'description' => __('在后端控制器初始化前触发，允许其他模块在初始化前执行操作。'),
        'doc' => 'app/后端控制器初始化前.md',
    ],
    'Framework_App::backend_controller_init_after' => [
        'name' => __('后端控制器初始化后'),
...
=======
    ...
    'Framework_FrontendController::init_after' => [
        'name' => __('前端控制器初始化后'),
    ...
    'Framework_FrontendRestController::init_after' => [
...
>>>>>>> dev-new
    ...
    // ========== 注册事件 ==========
    'Framework_Register::register_installer' => [
        'name' => __('注册安装器'),
    ...
    // ========== HTTP事件 ==========
    'WelineFramework_Http::process_area' => [
        'name' => __('处理区域'),
        'description' => __('在处理HTTP请求区域时触发，允许其他模块自定义区域处理逻辑。'),
        'doc' => 'http/处理区域.md',
    ],
    'Weline_Framework_http_response_no_router_before' => [
        'name' => __('响应无路由前'),
...
=======
    ...
    'Weline_Framework::maintenance' => [
        'name' => __('维护模式'),
        'description' => __('在系统进入维护模式时触发，允许其他模块自定义维护模式的响应方式。例如：API请求可以统一返回JSON格式的维护提示。'),
        'doc' => 'maintenance/维护模式.md',
    ],
    
    // ========== 卸载服务事件 ==========
    'Framework_UninstallService::uninstall' => [
        'name' => __('卸载服务'),
    ...
    // ========== 部署模式事件 ==========
    'Framework_Deploy_Mode_Set::prod_after' => [
