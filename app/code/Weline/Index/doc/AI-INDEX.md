...
4. 本文件：`app/code/Weline/Index/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Index/doc/README.md`
...
入口/配置文件：
- `app/code/Weline/Index/composer.json`
...
- 识别到 QueryProvider 相关 PHP 文件：extends/module/Weline_Framework/Query/ContactQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/Index/doc/README.md`
- `app/code/Weline/Index/doc/功能现状.md`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Index> [operation]` 或对应 `w_query` 帮助。
