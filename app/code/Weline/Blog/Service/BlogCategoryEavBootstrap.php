...
/**
 * Ensures blog_category EAV attribute set with name and code defaults.
 */
final class BlogCategoryEavBootstrap
{
    /**
    ...
    public function ensureCategorySchema(): array
    {
        ...
        $setId = $this->ensureSet($entityId, 'blog_category_default', '博客分类默认');
    ...
    private function resolveEntityId(): int
    {
        ...
        $entity->clearData()
            ->where(EavEntity::schema_fields_code, BlogCategoryAttributeEntity::entity_code)
            ->find()
            ->fetch();
