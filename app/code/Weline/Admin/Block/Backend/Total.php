...
class Total extends \Weline\Framework\View\Block
{
    ...
    public function __init()
    {
        ...
        $this->assign('up_down', $rateValue >= 0 ? 'up' : 'down');
        $this->assign('rate', number_format($rateValue, 0));
        $this->assign('rate_tone', $rateValue >= 0 ? 'success' : 'danger');
        $this->assign('gauge_progress', number_format(min(100, abs($rateValue)), 0, '.', ''));
    }
}
