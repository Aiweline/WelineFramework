...
4. 本文件：`app/code/Weline/Multipass/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Multipass/doc/README.md`
...
- `app/code/Weline/Multipass/composer.json`
...
- 识别到 QueryProvider 相关 PHP 文件：extends/module/Weline_Framework/Query/MultipassAdminQueryProvider.php；前端/跨模块读数据先查 query 帮助。
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Multipass> [operation]` 或对应 `w_query` 帮助。
