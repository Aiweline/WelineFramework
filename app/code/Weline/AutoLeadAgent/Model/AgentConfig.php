 ...
 * 用于存储模块配置信息
 */
#[Table(comment: '自动引导配置表')]
#[Index(name: 'uk_config_key_scope', columns: ['config_key', 'scope'], type: 'UNIQUE', comment: '配置键、作用域唯一索引')]
#[Index(name: 'idx_scope', columns: ['scope'], comment: '作用域索引')]
class AgentConfig extends Model
{
    public const schema_table = 'weline_auto_lead_agent_config';
    public const schema_primary_key = 'config_id';
    #[Col('int', 0, nullable: false, primaryKey: true, autoIncrement: true, comment: '配置ID')]
    ...
    #[Col('varchar', 50, nullable: false, default: 'default', comment: '作用域')]
