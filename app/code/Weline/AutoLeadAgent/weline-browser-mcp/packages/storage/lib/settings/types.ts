...
// Local provider uses transformers.js for local WASM inference
export enum ProviderTypeEnum {
  Local = 'local',  // 本地 WASM 推理（无需 API Key）
  OpenAI = 'openai',
  Anthropic = 'anthropic',
  DeepSeek = 'deepseek',
  Gemini = 'gemini',
...
export const llmProviderModelNames = {
  // 本地 WASM 推理模型（无需 API Key，完全离线）
  [ProviderTypeEnum.Local]: [
    'Qwen/Qwen2.5-0.5B-Instruct',       // 500MB，轻量级中文模型
    'Qwen/Qwen2.5-1.5B-Instruct',       // 1.5GB，中等规模中文模型
    'onnx-community/Llama-3.2-1B-Instruct', // 1.2GB，Meta 小型模型
    'microsoft/Phi-3-mini-4k-instruct-onnx-web', // 2.3GB，微软推理模型
  ],
