...
const CANDIDATE_ROUTES = ["vue","index","config","dashboard"];
...
moduleDescribe(test, MODULE, 'Weline_Vue 后台流程', () => {
  moduleCase(
    test,
