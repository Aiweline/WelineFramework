...
namespace Weline\Event\Extends\Module\Weline_Framework\Query;

use Weline\Framework\Manager\ObjectManager;
use Weline\Framework\Service\Query\Provider\QueryProviderInterface;

class EventAdminQueryProvider implements QueryProviderInterface
{
    ...
    public function getDescriptor(): array
    {
        return [
            'provider' => 'event',
            'name' => 'Weline_Event admin bridge',
            'module' => 'Weline_Event',
            'operations' => [[
                'name' => 'adminRequest',
