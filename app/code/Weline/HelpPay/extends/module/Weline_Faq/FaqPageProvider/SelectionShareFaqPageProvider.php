...
final class SelectionShareFaqPageProvider implements FaqPageProviderInterface
{
    ...
    public function title(): string { return (string) __('分享给朋友（帮选规格）'); }
    public function summary(): string { return (string) __('与帮我付不同：朋友自己结账下单'); }
    ...
    public function group(): string { return (string) __('分享'); }
}
