...
- 识别到 QueryProvider 相关 PHP 文件：extends/module/Weline_Framework/Query/MaintenanceAdminQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/Maintenance/doc/README.md`
- `app/code/Weline/Maintenance/doc/event/维护模式.md`
- `app/code/Weline/Maintenance/doc/功能现状.md`
- `app/code/Weline/Maintenance/doc/开发日志.md`
- `app/code/Weline/Maintenance/doc/需求.md`
