...
- `Queue`：队列生产/消费入口。读 Queue 技能和模块文档后再改。 文件数：4
...
- 识别到 QueryProvider 相关 PHP 文件：Test/Unit/Service/QueueDispatchServiceTest.php、extends/module/Weline_Framework/Query/QueueQueryProvider.php；前端/跨模块读数据先查 query 帮助。
