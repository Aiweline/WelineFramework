...
4. 本文件：`app/code/Weline/Sticker/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Sticker/doc/README.md`
...
入口/配置文件：
- `app/code/Weline/Sticker/etc/backend/menu.xml`
- `app/code/Weline/Sticker/composer.json`
...
- `app/code/Weline/Sticker/doc/README.md`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Sticker> [operation]` 或对应 `w_query` 帮助。
