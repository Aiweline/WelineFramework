...
use Weline\GenerativeEngineOptimization\Model\Feed as FeedModel;
 ...
 */
#[Acl('Weline_GenerativeEngineOptimization::feed_list', 'Feed管理', 'mdi-rss', 'Feed管理', 'Weline_GenerativeEngineOptimization::geo_manager')]
class Feed extends BackendController
{
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::feed_list_index', '查看Feed列表', 'mdi-rss', '查看Feed列表')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::feed_edit', '编辑Feed', 'mdi-pencil', '编辑Feed')]
        ...
        try {
            ...
            if ($id > 0) {
                ...
                if (!$feed->getId()) {
                    ...
                    $this->redirect('generativeengineoptimization/backend/feed');
                    return '';
                }
            } else {
                $feed = $feedModel;
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::feed_save', '保存Feed', 'mdi-content-save', '保存Feed')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::feed_generate', '生成Feed', 'mdi-refresh', '生成Feed')]
