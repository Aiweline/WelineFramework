...
namespace Weline\GenerativeEngineOptimization\Controller\Backend;

use Weline\Framework\App\Controller\BackendController;
use Weline\Framework\Acl\Acl;
use Weline\Framework\Manager\ObjectManager;
use Weline\Framework\Manager\Message;
use Weline\GenerativeEngineOptimization\Model\Platform as PlatformModel;
 ...
 */
#[Acl('Weline_GenerativeEngineOptimization::platform_list', '平台管理', 'mdi-cloud', '平台管理', 'Weline_GenerativeEngineOptimization::geo_manager')]
class Platform extends BackendController
{
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_list_index', '查看平台列表', 'mdi-cloud', '查看平台列表')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_edit', '编辑平台', 'mdi-pencil', '编辑平台')]
        ...
        try {
            ...
            if ($id > 0) {
                ...
                if (!$platform->getId()) {
                    ...
                    $this->redirect('generativeengineoptimization/backend/platform');
                    return '';
                }
            } else {
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_save', '保存平台', 'mdi-content-save', '保存平台')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_account', '平台账户管理', 'mdi-account', '平台账户管理')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_account_save', '保存账户', 'mdi-content-save', '保存账户')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::platform_test', '测试连接', 'mdi-connection', '测试连接')]
