 ...
 */
#[Acl('Weline_GenerativeEngineOptimization::push_list', '推送管理', 'mdi-send', '推送管理', 'Weline_GenerativeEngineOptimization::geo_manager')]
class Push extends BackendController
{
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::push_list_index', '查看推送历史', 'mdi-history', '查看推送历史')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::push_push', '一键推送', 'mdi-send', '一键推送')]
     ...
     * @return string
     */
    #[Acl('Weline_GenerativeEngineOptimization::push_execute', '执行推送', 'mdi-play', '执行推送')]
