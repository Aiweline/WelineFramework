...
final class FaqSeoFactsBuilderTest extends TestCase
{
    public function testHubProfileContractIncludesFaqsAndFaqPageType(): void
    {
        $facts = (string)file_get_contents(dirname(__DIR__, 3) . '/Service/FaqSeoFactsBuilder.php');
        $hub = (string)file_get_contents(dirname(__DIR__, 3) . '/Service/FaqHubContent.php');
    ...
    {
        self::assertFileExists(dirname(__DIR__, 3) . '/extends/module/Weline_Seo/SeoProfileProvider/FaqSeoProfileProvider.php');
        self::assertFileExists(dirname(__DIR__, 3) . '/extends/module/Weline_Cms/PageKind/FaqPageKindProvider.php');
        $kind = (string)file_get_contents(dirname(__DIR__, 3) . '/extends/module/Weline_Cms/PageKind/FaqPageKindProvider.php');
        self::assertStringContainsString("return 'faq'", $kind);
