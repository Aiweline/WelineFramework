...
/**
 * Remediate FAQ soft-tone returns: retail returns + site hub_returns for default website locales.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/Faq/scripts/remediate-faq-soft-tone-returns.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/Faq/scripts/remediate-faq-soft-tone-returns.php --apply
 */
...
$pack = require __DIR__ . '/data/faq-soft-tone-returns.v1.php';
