...
/**
 * Remediate FAQ compliance copy: retail returns + site hub_0 for default website locales.
 *
 * Usage:
 *   php -d memory_limit=512M app/code/Weline/Faq/scripts/remediate-faq-compliance-returns-hub0.php --dry-run
 *   php -d memory_limit=512M app/code/Weline/Faq/scripts/remediate-faq-compliance-returns-hub0.php --apply
 */
...
/** @var array{returns: array<string, array{question:string, answer:string}>, hub_0: array<string, array{question:string, answer:string}>} $pack */
$pack = require __DIR__ . '/data/faq-compliance-returns-hub0.v1.php';
...
$summary = [
    ...
    'hub_0' => ['updated' => 0, 'inserted' => 0, 'unchanged' => 0, 'missing_pack' => []],
    'publisher' => 'pending',
    'sample' => [],
];
