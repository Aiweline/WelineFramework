...
final class CheckoutTaxIdentitySlotContractTest extends TestCase
{
    public function testIndexAndExpressReviewDeclareTaxIdentitySlot(): void
    {
        ...
        self::assertStringContainsString('Weline_Tax::templates/frontend/widgets/checkout-tax-identity.phtml', $index);
        self::assertStringContainsString('Weline_Tax::templates/frontend/widgets/checkout-tax-identity.phtml', $express);
        ...
        // Soft fallback when Theme bake/edge lag empties shipping slot.
