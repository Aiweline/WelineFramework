...
- 识别到 QueryProvider 相关 PHP 文件：Service/CronAdminReadService.php、extends/module/Weline_Framework/Query/CronQueryProvider.php；前端/跨模块读数据先查 query 帮助。

## doc 目录

- `app/code/Weline/Cron/doc/README.md`
- `app/code/Weline/Cron/doc/功能现状.md`
...
- `app/code/Weline/Cron/doc/开发日志.md`
- `app/code/Weline/Cron/doc/需求.md`
