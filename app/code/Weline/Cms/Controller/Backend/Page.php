...
#[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder', 'CMS内容管理系统', 'mdi mdi-file-document-edit', '管理和构建页面')]
class Page extends BackendController
{
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_index', '页面列表', 'mdi mdi-view-list', '查看页面列表')]
    public function index()
    {
        // 设置页面标题
        $this->assign('page_title', __('CMS内容管理系统'));
        $this->assign('breadcrumb_parent', __('内容管理'));
        $this->assign('breadcrumb_current', __('CMS内容管理系统'));
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_create', '新建页面', 'mdi mdi-plus', '新建页面')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_create_post', '新建页面请求', '', '新建页面请求')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_edit', '编辑页面', 'mdi mdi-pencil', '编辑页面')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_edit_post', '编辑页面请求', '', '编辑页面请求')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_delete', '删除页面', 'mdi mdi-delete', '删除页面')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_translate', '翻译页面', 'mdi mdi-translate', '翻译页面')]
    ...
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_translate_post', '翻译页面请求', '', '翻译页面请求')]
     ...
     * 实时扫描样式目录并返回最新的样式列表
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_get_styles', '获取样式列表', '', '获取样式列表')]
     ...
     * 获取样式配置信息（AJAX接口）
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_get_style_config', '获取样式配置', '', '获取样式配置信息')]
     ...
     * 预览页面（支持指定语言）
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_preview', '预览页面', 'mdi mdi-eye', '预览页面')]
     ...
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::style_preview_image', '样式预览图', 'mdi mdi-image', '获取样式预览图片')]
    public function stylePreviewImage()
    {
        ...
        try {
            ...
            // 构建完整的文件路径
            $baseDir = BP . '/app/code/Weline/Cms/view/templates/';
     ...
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_upload', '可视化字段文件上传', '', '上传文件到媒体目录', 'Weline_Cms::page_builder')]
    public function uploadAsset()
    {
        try {
            ...
            $baseDir = BP . 'pub/media/cms/uploads/';
            if (!is_dir($baseDir)) {
            ...
            $publicUrl = '/media/cms/uploads/' . $subDir . $filename;
     ...
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_list_assets', '列出页面资源', '', '列出页面资源')]
     ...
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_upload_asset_to', '上传页面资源(指定目录)', '', '上传页面资源(指定目录)')]
     ...
     * 导出页面配置到Excel
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_export_config', '导出页面配置', '', '导出页面配置到Excel')]
     ...
     * 从Excel导入页面配置
     */
    #[\Weline\Framework\Acl\Acl('Weline_Cms::page_builder_import_config', '导入页面配置', '', '从Excel导入页面配置')]
