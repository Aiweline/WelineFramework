...
4. 本文件：`app/code/Weline/Cms/doc/AI-INDEX.md`
5. 模块说明：`app/code/Weline/Cms/doc/README.md`
...
入口/配置文件：
- `app/code/Weline/Cms/etc/backend/menu.xml`
...
- 涉及跨模块读数据时，先查 `php bin/w query:help <provider|Weline_Cms> [operation]` 或对应 `w_query` 帮助。
