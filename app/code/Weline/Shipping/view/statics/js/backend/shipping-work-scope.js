/**
 * Shipping backend work-scope switcher.
 * Binds to Taglib scope select: hidden input id=shipping-work-scope, tree id=shipping-work-scope_tree.
 * Do not querySelector children of the hidden input (listeners will never attach).
 */
(function () {
    'use strict';
    var field = document.getElementById('shipping-work-scope');
    var tree = document.getElementById('shipping-work-scope_tree');
    if (!field) {
        return;
    }
    ...
    try {
        var raw = document.getElementById('shipping-work-scope-i18n');
    ...
    function selectedNode() {
        return document.querySelector('#shipping-work-scope_tree [data-w-scope-node].selected')
            || document.querySelector('#shipping-work-scope_dropdown [data-w-scope-node].selected');
    }
