...
1. **导入地区数据**：进入后台 **配送系统 > 地区管理**，点击"从i18n同步"
2. **配置快递公司**：进入 **配送系统 > 快递公司**，添加常用快递公司
3. **创建费用模板**：进入 **配送系统 > 费用模板**，创建配送费用计算模板
4. **配置配送区域**：进入 **配送系统 > 配送区域**，创建配送覆盖区域
5. **创建配送服务**：进入 **配送系统 > 配送服务**，关联快递公司、区域和模板
