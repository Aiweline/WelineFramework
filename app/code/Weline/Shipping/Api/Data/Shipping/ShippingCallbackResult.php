...
final class ShippingCallbackResult
{
    ...
    public static function ok(string $providerEventId, array $payload = []): self
    {
        return new self(self::STATUS_OK, true, $providerEventId, '', $payload);
    }
}
