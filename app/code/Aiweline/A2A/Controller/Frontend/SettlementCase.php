...
use Aiweline\A2A\Model\SettlementCase as SettlementCaseModel;
use Aiweline\A2A\Service\SettlementCaseService;
...
class SettlementCase extends FrontendController
{
    ...
    public function index(): string
    {
        ...
        return $this->getTemplate()->fetch('Aiweline_A2A::templates/Frontend/SettlementCase/index.phtml');
    }
