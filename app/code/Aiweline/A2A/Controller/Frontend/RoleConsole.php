...
use Aiweline\A2A\Service\RoleActionPolicyService;
use Aiweline\A2A\Service\RoleSessionService;
use Aiweline\A2A\Service\RuntimeProofActionLinkService;
use Aiweline\A2A\Service\TradeActorAssignmentService;
...
class RoleConsole extends FrontendController
{
    ...
    public function index(): string
    {
        ...
        return $this->getTemplate()->fetch('Aiweline_A2A::templates/Frontend/RoleConsole/index.phtml');
    }
