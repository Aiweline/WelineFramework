...
class NotificationAdminPageDataService
{
    ...
    private function normalizeItem(array $item): array
    {
        ...
        return [
            ...
            'target_url' => (string) ($item[Notification::schema_fields_TARGET_URL] ?? $item['target_url'] ?? ''),
            'is_read' => $isRead,
    ...
    private function normalizeModel(Notification $notification): array
    {
        ...
        return [
            ...
            'target_url' => (string) $notification->getData(Notification::schema_fields_TARGET_URL),
            'is_read' => $isRead,
            'read_label' => $isRead === 1 ? (string) __('Read') : (string) __('Unread'),
