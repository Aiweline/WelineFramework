...
4. 本文件：`app/code/WeShop/Cart/doc/AI-INDEX.md`
5. 模块说明：`app/code/WeShop/Cart/doc/README.md`
6. 只读取本次任务相关源码、配置和验证入口

## 模块身份

- 模块代码：`WeShop_Cart`
- 目录：`app/code/WeShop/Cart`
- Vendor：`WeShop`
- Module：`Cart`
