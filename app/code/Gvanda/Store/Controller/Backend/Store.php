...
namespace Gvanda\Store\Controller\Backend;
...
#[Acl('Gvanda_Store::manager', '店铺管理', 'ri-settings-2-fill', '店铺管理', 'Gvanda_Store::main')]
class Store extends BackendController
{
    private \Gvanda\Store\Model\Store $store;

    public function __construct(
        \Gvanda\Store\Model\Store $store,
    ) {
        $this->store = $store;
    }

    #[Acl('Gvanda_Store::listing', '店铺列表', 'mdi mdi-format-list-bulleted-squarel', '店铺管理')]
    ...
    #[Acl('Gvanda_Store::add_page', '店铺添加', 'mdi mdi-pen-plus', '店铺添加')]
    ...
    #[Acl('Gvanda_Store::add_post', '店铺添加', 'mdi mdi-pen-plus', '店铺添加')]
    ...
    #[Acl('Gvanda_Store::edit', '店铺编辑', 'ri-edit-2-fill', '店铺编辑')]
    ...
    #[Acl('Gvanda_Store::code_exit', '店铺编码查询', 'mdi mdi-file-find', '店铺编码查询')]
    ...
    #[Acl('Gvanda_Store::delete', '店铺删除', 'mdi mdi-delete', '店铺删除')]
